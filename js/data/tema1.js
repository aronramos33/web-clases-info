  ...
  apartados: [
    ...
    },
    {
      ...
      html:
        ...
        "<p><strong>C) El diodo.</strong> Formado por semiconductores (silicio, germanio). Permite el paso de la corriente <strong>solo en un sentido</strong>: del <strong>ánodo</strong> (+) al <strong>cátodo</strong> (−); en sentido contrario la bloquea. Los más comunes son los <strong>led</strong> (Light Emitting Diode), que emiten luz; también los hay ultravioleta e infrarrojos.</p>" +
