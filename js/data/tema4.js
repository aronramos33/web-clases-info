  ...
  apartados: [
    ...
    },
    {
      ...
      html:
        ...
        '<figure class="figura"><img src="assets/img/tema4/fig4-01.jpg" alt="Organigrama de los siete pasos del movimiento de un ratón óptico" loading="lazy"><figcaption>Figura 4.1 del libro — Organigrama del movimiento de un ratón.</figcaption></figure>' +
        "<h4>4.3.2 Teclado</h4>" +
    ...
    },
    {
      ...
      html:
        ...
        "</ul>" +
        '<figure class="figura"><img src="assets/img/tema4/fig4-04.jpg" alt="Ojo humano con el patrón de reconocimiento de iris superpuesto" loading="lazy"><figcaption>Figura 4.4 del libro — Escáner de reconocimiento de iris.</figcaption></figure>' +
        '<figure class="figura"><img src="assets/img/tema4/fig4-05.jpg" alt="Escáner 3D Ciclop de BQ con su plataforma giratoria" loading="lazy"><figcaption>Figura 4.5 del libro — Escáner Ciclop de BQ.</figcaption></figure>' +
    ...
    },
    {
      ...
      html:
        ...
        "</tbody></table>" +
        '<figure class="figura"><img src="assets/img/tema4/fig4-09.jpg" alt="Impresora de tiques con ribbon y rollo de ribbon" loading="lazy"><figcaption>Figuras 4.9 y 4.10 del libro — Impresora de tiques con ribbon y rollo de ribbon.</figcaption></figure>' +
        ...
        '<figure class="figura"><img src="assets/img/tema4/fig4-14.jpg" alt="Bobina de filamento flexible Filaflex para impresora 3D" loading="lazy"><figcaption>Figura 4.14 del libro — Filaflex, filamento altamente flexible.</figcaption></figure>' +
